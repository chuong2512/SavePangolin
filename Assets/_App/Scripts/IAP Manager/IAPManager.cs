...
public class IAPKey
{
	public const string PACK1="save_pangolin_add1";
	public const string PACK2="save_pangolin_add2";
	public const string PACK3="save_pangolin_add5";
	public const string PACK4="save_pangolin_add10";
	public const string PACK5="save_pangolin_add20";
}
